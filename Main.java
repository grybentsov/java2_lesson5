package ru.geekbrains.part_2_lesson_5;

public class Main {

    static final int size = 10000000;
    static final int h = size / 2;
// Метод для подсчета каждой ячейки массива (общий)
...
// Первый поток
        new Thread () {
            @Override
            public void run() {
                float [] a1 = calc(array1);
                System.arraycopy(a1, 0, array1, 0, a1.length); // копирование данных из одного массива в другой
            }
        }.start();
// Второй поток
        new Thread () {
            @Override
            public void run() {
                float [] a2 = calc(array2);
                System.arraycopy(a2, 0, array2, 0, a2.length); // копирование данных из одного массива в другой
            }
        }.start();
        // Обратная склейка массивов в один 
        System.arraycopy(array1, 0, arr, 0, h);
        System.arraycopy(array2, 0, arr, h, h);
        System.out.println("Double thread running time is: " + (System.currentTimeMillis() - a));
    }
